...
WEATHER_ICONS = {
    0: f"{CACHE_DIR}/icons/sun.svg",
    1: f"{CACHE_DIR}/icons/partial_clouds.svg",
    2: f"{CACHE_DIR}/icons/clouds.svg",
    3: f"{CACHE_DIR}/icons/rain.svg",
    4: f"{CACHE_DIR}/icons/rain.svg",
    5: f"{CACHE_DIR}/icons/storm.svg",
    6: f"{CACHE_DIR}/icons/snow.svg",
    7: f"{CACHE_DIR}/icons/fog.svg",
}
...
class WeatherWidget(Widget):
    ...
    def weather_icon_src(
        ...
        return posixpath.join(CACHE_DIR, "icons", "no-internet.svg")
...
class BottomBar(Widget):
    def __init__(
        ...
        self.button: Label = Label(
            Img(
                src=f"{CACHE_DIR}/icons/bars-solid.svg",
                width="25",
                height="25",
                _class="p-0",
...
class Drawer(Widget):
    def __init__(
        ...
        self._settings_item: Li = Li(
            [
                Img(
                    src=f"{CACHE_DIR}/icons/gear-solid.svg",
                    width=25,
                    height=25,
                    style="filter: invert(100%);",
        ...
        self._about_item: Li = Li(
            [
                Img(
                    src=f"{CACHE_DIR}/icons/circle-info-solid.svg",
                    width=25,
                    height=25,
                    style="filter: invert(100%);",
                    _class="bg-transparent hover:bg-transparent p-0",
        ...
        self.add_interaction(
            ...
            Control(
                ...
                callback=lambda renderer, _: renderer.open_dialog("about-dialog"),
    ...
    def __init__(
        ...
        self.add_interaction(
            ...
            Control(
                ...
                callback=(
                    lambda renderer, _: renderer.close_dialog("about-dialog")
                ),
                source=self._button,
                target=None,  # no target
            ),
...
class BackgroundContainer(Widget):
    ...
    def wallpaper_url(
        ...
        elif not wallpaper_path:
            wallpaper_url = posixpath.join(
                CACHE_DIR,
                "images",
                selected_wallpaper,
            )
